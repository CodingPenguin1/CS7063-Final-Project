...
train_loader, test_loader = get_loaders(data_dir='C:/Users/ryanj/MyFiles/Data/pytorch_datasets', batch_size=128, dataset='cifar', train_transforms=None, test_transforms=None)
